 ...
 require 'database.php';
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO dict (word ) values( ? )";
			$q = $pdo->prepare($sql);
...
<body>
    <div class="container">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Добавляем в основной словарь</h3>
		    		</div>
    		
	    			<form class="form-horizontal" action="maindict_create.php" method="post">
					  ...
					  <div class="form-actions">
						  ...
						  <a class="btn" href="maindict.php">Назад</a>
					   </div>
					</form>
				</div>
